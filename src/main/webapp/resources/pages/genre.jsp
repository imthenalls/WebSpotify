...
<div class="row" id="mediaPane">
  <div class="col-xs-12">
    <div id="mediaInfo" class="col-xs-8">
          <h2 class="mediaName">${currentGenre}</h2>   
    </div>
  </div>
</div>
<div class="row tableContainer">
  <table class="table songTable">
    ...
    <c:forEach items="${genreSongs}" varStatus="loop" var="Song">
      <tr class="tableRow">
        <td>
          <a class="playHide">
                ${loop.index+1}
          </a>            
          <a href="#" onclick="playSong(${Song.songId},'genreSongs',${loop.index})">
        ...
        <td class="text-right">
          <div class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="#" songId="${Song.songId}" currentPage="genreSongs.jsp" class="unfollowSong">Unfollow Song</a></li>
